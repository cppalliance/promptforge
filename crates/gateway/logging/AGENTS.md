...
- Every record crosses `redact::redact_line` at the enqueue chokepoint before it reaches the queue. Logs never record credentials, environment values, request bodies, audio, transcript text, prompts, or full local model paths.
