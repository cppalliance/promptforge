...
// packaged UI build. The crate's build.rs verifies the manifest before
// embedding dist/ into a release binary, so the input-hash algorithm here
// is mirrored exactly in ../build/manifest.rs: sha256 over the
// byte-sorted, ui-relative forward-slash paths of every build input,
