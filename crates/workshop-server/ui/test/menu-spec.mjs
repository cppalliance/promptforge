...
const bundle = await esbuild.build({
  stdin: {
    contents: `
      import "./src/ui/menu/menubar.contribution.ts";
      import "./src/ui/menu/stubs.contribution.ts";
...
const SPEC = {
  ...
  "menubar/file": [
    ...
    ["workbench.action.duplicateWorkspace", "3_workspace", "stub", "Duplicate Workspace"],
