...
These rules bind `crates/workshop-server`. The repo-root AGENTS.md applies on top; the embedded UI has its own AGENTS.md under `ui/`. Rules here are target-state: refactor-era code lands in this shape.
