...
/// # Examples
/// ```
/// use promptforge_gateway_config::SttRole;
///
...
impl SttModelConfig {
    ...
    /// # Examples
    /// ```
    /// # use promptforge_gateway_config::{Config, SttRole};
    /// # let config = Config::from_toml_str(
    /// #     "config-version = 2\n[server]\nbind = \"127.0.0.1:8080\"\napi_key = \"secret\"\n\
    /// #      [[stt_model]]\nname = \"speech\"\nrole = \"interim\"\nsource = \"/speech.bin\"\nvram_gb = 1.0\n",
    /// # )?;
...
/// # Examples
/// ```
/// use promptforge_gateway_config::RECOMMENDED_STT_MODELS;
///
...
impl RecommendedSttModel {
    ...
    /// # Examples
    /// ```
    /// use promptforge_gateway_config::{RECOMMENDED_STT_MODELS, SttRole};
    ///
