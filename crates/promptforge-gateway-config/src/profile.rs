...
/// # Examples
/// ```
/// use promptforge_gateway_config::ProfileSelection;
///
...
/// # Examples
/// ```
/// use promptforge_gateway_config::{ProfileName, ProfileState};
///
/// let name = ProfileName::parse("work")?;
/// assert_eq!(ProfileState::new(&name).active_profile(), "work");
/// # Ok::<(), promptforge_gateway_config::ProfileNameError>(())
/// ```
...
impl ProfileState {
    ...
    /// # Examples
    /// ```
    /// use promptforge_gateway_config::ProfileState;
    ///
...
/// # Examples
/// ```
/// use promptforge_gateway_config::profile_state_path;
/// use std::path::Path;
///
/// assert_eq!(
