...
impl CapabilityId {
    ...
    /// # Ok::<(), shared_promptforge_api::capabilities::CapabilityIdError>(())
    /// ```
...
impl RunServices {
    ...
    /// use shared_promptforge_api::capabilities::RunServices;
    ///
...
impl CapabilityError {
    ...
    /// # Examples
    /// ```
    /// use shared_promptforge_api::capabilities::{CapabilityError, CapabilityErrorKind};
    ///
