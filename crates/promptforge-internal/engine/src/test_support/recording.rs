...
#[cfg(test)]
#[must_use]
pub(crate) fn null_emitter() -> promptforge_types::emitter::Emitter {
    promptforge_types::emitter::Emitter::root(
        promptforge_types::emitter::EventSink::default(),
        "test",
        promptforge_types::emitter::DebugMode::Off,
    )
}
