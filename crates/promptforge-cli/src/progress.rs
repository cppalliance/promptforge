//! Setup progress for the CLI: a small operation tree around the model
//! catalog fetch, the embedding-model load, and tool indexing, rendered to
//! indicatif bars while stderr is a terminal.
//!
...
use shared_progress::{OperationSnapshot, ProgressHandle, ProgressHub, ProgressTree};
