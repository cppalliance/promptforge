...
const result = await esbuild.build({
  stdin: {
    contents: `
      export { setupGatewayConfigBridge } from "./src/parts/gateway/gateway-config-bridge.ts";
      export { GatewayConfigPanel } from "./src/parts/gateway/gateway-config-panel.ts";
    `,
