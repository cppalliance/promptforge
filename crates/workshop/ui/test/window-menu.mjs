// Unit test for the menubar (src/parts/menu/menubar.ts) composing the menu
// popover widget (src/parts/menu/menu.ts) over the services registries.
...
// (src/parts/menu/index.ts) is covered end-to-end by the boot tests
