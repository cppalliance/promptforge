// Unit test for the native workspace drop handler (src/parts/workspace/workspace-drops.ts).
...
const bundle = await esbuild.build({
  entryPoints: [path.join(uiDir, "..", "src", "parts", "workspace", "workspace-drops.ts")],
  bundle: true,
  write: false,
  format: "esm",
  platform: "browser",
