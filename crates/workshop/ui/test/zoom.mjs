// Unit test for the global zoom (src/parts/chrome/zoom.ts) and its menu
// rows, registered by the chrome contribution
// (src/parts/chrome/chrome.contribution.ts) into View > Appearance. Bundles
