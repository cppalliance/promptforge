...
import { CLOSED_EDITORS, ClosedEditors } from "./parts/editor/closed-editors";
import { EDITOR_SETTINGS_SERVICE, EditorSettingsService } from "./parts/editor/editor-settings-service";
import { setupGatewayConfigBridge } from "./parts/gateway/gateway-config-bridge";
import { StatusBar, STATUS_BAR } from "./parts/status/status-bar";
...
import { QuickInputService, QUICK_INPUT_SERVICE } from "./parts/quickinput/quick-input";
