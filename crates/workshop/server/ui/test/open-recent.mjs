...
// (src/ui/workspace/open-recent.ts): the menu provider's dynamic rows
...
const bundle = await esbuild.build({
  stdin: {
    contents: `
      export { createRecentMenuProvider, createFileQuickAccessProvider, isWorkspaceFilePath } from "./src/ui/workspace/open-recent.ts";
