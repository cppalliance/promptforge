// Integration test for the Run window panel (src/ui/run/, the run tab's
// loading shimmer in src/ui/layout/run-tab.ts, the tree's drag-out in
...
const bundle = await esbuild.build({
  stdin: {
    contents: `
      ...
      export { initZones, openInZone, panelIdFor, zoneOfPanel } from "./src/ui/layout/zones.ts";
      export { createPanelComponent, createPanelTabComponent } from "./src/ui/layout/panel-types.ts";
      export { setupWorkspaceDrops } from "./src/ui/workspace/workspace-drops.ts";
    `,
