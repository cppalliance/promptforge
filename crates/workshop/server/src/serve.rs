...
use workshop_gateway::{GatewayUpdater, ResolvedGateway};
...
pub struct ServerHandle {
    ...
    initial_gateway_identity: Option<gateway_api_discovery::ValidatedConnection>,
...
impl ServerHandle {
    ...
    #[must_use]
    pub fn initial_gateway_identity(&self) -> Option<&gateway_api_discovery::ValidatedConnection> {
...
fn spawn_inner(
    ...
    let gateway = match gateway {
        ...
        None => workshop_gateway::resolve(&config.gateway).map_err(StateError::Resolution)?,
    };
