...
This crate owns the shared Gateway connection-file and sidecar lifecycle seam.

- This is the only implementation of connection-file discovery, atomic owner-only publication, shutdown removal, stale resolution, launch locking, health probing, and authenticated shutdown. Consumers do not reimplement those contracts.
