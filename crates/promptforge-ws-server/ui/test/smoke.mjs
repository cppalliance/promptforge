...
// Reasoning frames render the Thinking block: a reply that streams scratch
// work before its content must leave a durable, expandable Thinking toggle
// in the feed, auto-collapsed once the answer streamed.
if (input && form && history) {
  const socket = chatSockets[0];
  if (socket) {
