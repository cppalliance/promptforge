...
use promptforge_gateway_config::{Config, LocalModelConfig, ModelKind};
use promptforge_gateway_local::artifacts::existing_model_path;
use promptforge_gateway_local::chat_templates::{Family, model_family_mappings};
use promptforge_gateway_local::{
...
fn model_reply(
    ...
    cache_root: Result<&Path, &promptforge_gateway_local::LocalError>,
