...
use promptforge_gateway_config::{ConfigErrorKind, save_config_shadow};
...
#[cfg(test)]
mod tests {
    use promptforge_gateway_config::{Config, ProfileSelection, profile_state_path, shadow_path};
