...
- `crates/promptforge-tool-picker` - library: resolves a plain-English capability need to a tool from an abstract catalog (in progress: catalog, config, and error types, embedded model assets, and the local CPU embedding backend)
