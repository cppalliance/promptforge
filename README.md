...
| [promptforge-gateway-client](crates/promptforge-gateway-client) | Gateway model client: OpenAI-shaped completions transport, wire types, model catalog and binding vocabulary | [![Crates.io](https://img.shields.io/crates/v/promptforge-gateway-client.svg)](https://crates.io/crates/promptforge-gateway-client) |
