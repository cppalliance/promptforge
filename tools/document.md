...
Targets: `crates/gateway/` (the whole family: `app/`, `config/`, `config-ui/`, `local/`, `logging/`, `protocol/`, `routing/`, `web-search/`, `stt/`), `crates/shared-loopback/`, `gateway.local.example.toml`.
...
Targets: `crates/promptforge-internal/parser/`, `crates/promptforge-internal/engine/`, `prompts/`, `README.md`.
