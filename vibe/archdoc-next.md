...
N39 | observation | global-state @ crates/gateway/src/config_write.rs::PERSISTENCE_SEQUENCE: allocates persistence temporary suffixes from a process-wide atomic counter | Make profile replacement transactional; Harden prepared persistence names
