...
N25 | observation | facade @ crates/gateway-stt/src/lib.rs::test_fixtures: combines engine fixtures with speech runtime construction | Bound transcription workers and expose test fixtures; Replace the STT runtime with a speech facade
...
N35 | observation | hidden-dependency @ crates/gateway-stt/src/generation.rs::unload: waits for generation and engine reference counts outside its interface | Replace the STT runtime with a speech facade
